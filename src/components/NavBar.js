        ...
        {currentUsername &&
          <div className="nav-icon-div">
            ...
            <span className='position-relative' data-bs-toggle="tooltip" title='Notifications'>
              ...
              {privateNotificationMessages.length > 0 && <span className="position-absolute top-0 start-0 translate-middle bg-danger notification-number-div d-flex justify-content-center align-items-center" style={{ fontSize: "10px", width: "25px", height: "25px", borderRadius: "50%", pointerEvents: "none" }}><b>{privateNotificationMessages.length}</b></span>}
            </span>
          </div>}
      </nav>
      {currentUsername &&
